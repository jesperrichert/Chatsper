...
export function LoginForm({
  ...
  useEffect(() => {
    async function data() {
      if (config?.auth.validate_url == null) return
          ...
          <form className="p-6 md:p-8">
            <FieldGroup>
              ...
              <Field className="grid grid-cols-3 gap-4 ">
                ...
                <Button className={"bg-bg-accent rounded-2xl border-2 border-zinc-600 cursor-not-allowed"} type="button" disabled={true}>
